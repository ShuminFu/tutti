...
test("DesktopPreferencesService publishes scalar preference writes", async (t) => {
  const cases = [
    ...
    },
    {
      ...
      request: createPublishedPreferences({ agentRuntimeIdleMinutes: 5 }),
      event: createPreferences({ agentRuntimeIdleMinutes: 5 }),
      publish: (service: DesktopPreferencesService) =>
    ...
    },
    {
      ...
      request: createPublishedPreferences({ agentRuntimeIdleMinutes: 0 }),
      event: createPreferences({ agentRuntimeIdleMinutes: 0 }),
      publish: (service: DesktopPreferencesService) =>
    ...
    },
    {
      ...
      request: createPublishedPreferences({ agentRuntimeMaxResident: 0 }),
      event: createPreferences({ agentRuntimeMaxResident: 0 }),
      publish: (service: DesktopPreferencesService) =>
