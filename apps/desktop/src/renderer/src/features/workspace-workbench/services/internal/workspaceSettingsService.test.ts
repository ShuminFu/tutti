...
function createDesktopPreferencesService(input: {
  ...
  return {
    ...
    setAgentRuntimeKeepAliveEnabled: async (enabled) => enabled,
    setAgentRuntimeIdleMinutes: async (minutes) => minutes,
    setAgentRuntimeMaxResident: async (maxResident) => maxResident,
