    ...
    settings: {
      ...
      agent: {
        ...
        agents: {
          ...
          keepAlive: "Keep agent processes running",
          keepAliveHint:
            "Reuses the process for the next message instead of a cold start. Each resident session costs memory.",
          keepAliveFailed: "Couldn't save the agent process retention setting.",
          keepAliveIdleLabel: "Release after",
          keepAliveIdleMinutes: "{{count}} min idle",
          keepAliveIdleNever: "Never",
          keepAliveMaxResidentLabel: "Keep at most",
          keepAliveMaxResident: "{{count}} sessions",
          keepAliveMaxResidentUnlimited: "Unlimited",
