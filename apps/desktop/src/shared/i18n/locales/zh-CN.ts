    ...
    settings: {
      ...
      agent: {
        ...
        agents: {
          ...
          keepAlive: "Agent 进程常驻",
          keepAliveHint:
            "下一句话直接用现成进程，不用冷启动；每条常驻会话都占内存",
          keepAliveFailed: "无法保存 Agent 进程常驻设置",
          keepAliveIdleLabel: "空闲多久后释放",
          keepAliveIdleMinutes: "{{count}} 分钟",
          keepAliveIdleNever: "永不",
          keepAliveMaxResidentLabel: "最多常驻",
          keepAliveMaxResident: "{{count}} 条会话",
          keepAliveMaxResidentUnlimited: "不限",
          checkUpdates: "检查更新",
