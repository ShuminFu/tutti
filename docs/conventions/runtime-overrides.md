...
| `TUTTI_CLAUDE_SDK_SIDECAR_COMMAND`        | This document                                                                         | Overrides the command used by tuttid to launch the Claude SDK sidecar; unset runs the built-in Go sidecar in-process. |
| `TUTTI_CLAUDE_SDK_SIDECAR_ENTRY_PATH`     | This document                                                                         | Internal packaged-desktop handoff pointing tuttid at the vendored TypeScript Claude SDK sidecar entry.                |
