...
- [A Turn fails because the model endpoint rejects a tool declaration type](./agent-provider-setup.md#codex-model-plan-turns-fail-or-stay-waiting-against-a-chat-only-endpoint)
