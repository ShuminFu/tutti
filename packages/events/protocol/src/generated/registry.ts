...
export const businessEventTopicPreferencesAgentComposerDefaultsResolved =
  "preferences.agent.composer.defaults.resolved" as const;
...
export const businessEventCatalogRevision = "sha256:737e582518c5e91a" as const;
