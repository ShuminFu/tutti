    ...
    >
      <ContainerTag
        className={cn(
          ...
          "[&_h1]:mt-4 [&_h1]:mb-2 [&_h1]:text-[18px] [&_h1]:font-semibold [&_h1]:leading-[1.35]",
          "[&_h2]:mt-4 [&_h2]:mb-2 [&_h2]:text-[16px] [&_h2]:font-semibold [&_h2]:leading-[1.35]",
          "[&_h3]:mt-3 [&_h3]:mb-1.5 [&_h3]:text-[14px] [&_h3]:font-semibold [&_h3]:leading-[1.4]",
          "[&_h4]:mt-3 [&_h4]:mb-1.5 [&_h4]:text-[13px] [&_h4]:font-semibold [&_h4]:leading-[1.4]",
          "[&_h5]:mt-3 [&_h5]:mb-1 [&_h5]:text-[13px] [&_h5]:font-semibold [&_h5]:leading-[1.4] [&_h5]:text-[color-mix(in_srgb,var(--text-primary)_78%,transparent)]",
          "[&_h6]:mt-3 [&_h6]:mb-1 [&_h6]:text-[12px] [&_h6]:font-semibold [&_h6]:leading-[1.4] [&_h6]:text-[color-mix(in_srgb,var(--text-primary)_78%,transparent)]",
