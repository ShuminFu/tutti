...
export const zhCNAgentGui = {
  ...
  slashStatusClose: "关闭",
  slashStatusFiveHourLimit: "5 小时限额",
  slashStatusWeeklyLimit: "7 天限额",
  slashStatusLimitPercentLeft: "剩余 {{percent}}%",
  slashStatusLimitReset: "将于 {{reset}} 重置",
  ...
  revealInFileExplorer: "在文件管理器中打开",
  revealInFileManager: "在文件管理器中打开",
  revealFallbackDirectory: "文件已不存在或无法访问，已打开所在目录",
