...
func hermesDescriptor() ProviderDescriptor {
	return ProviderDescriptor{
		Identity: IdentityDescriptor{ID: HermesProviderID, DisplayName: "Hermes Agent", IconKey: "hermes", LocaleKey: "agentHost.agentGui.conversationFilterHermes", Aliases: []string{"hermes-agent", "hermes agent"}},
		Runtime: RuntimeDescriptor{
