...
type DesktopPreferences struct {
	...
	// AgentRuntimeMaxResident How many agent processes may stay resident at once. When the count exceeds this, the least recently used sessions are released first. 0 means unlimited. Optional on write; omitting it keeps the current value.
